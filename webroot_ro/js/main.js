...
var lanSelect = '<a class="lang-toggle"><span>中文</span><b style="border-top-color:#999" class="caret"></b></a><ul class="lang-menu none" style="top: 43px; z-index: 1000;"><li><a data-country="en">English</a></li><li><a data-country="cn">中文</a></li><li><a data-country="zh">繁體中文</a></li></ul><span>|</span>';

var goExit = '<span class="go-exit"><a style="margin-left:10px; color: #999;" href="goform/exit">Exit</a></span>';
$(".main-section-title").before('<div class="lang-set">' + /*OEM LANGUAGE*/ lanSelect + /*END*/ goExit + '</div>')